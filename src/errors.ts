export const NO_KEYFRAMES = "Failed to execute 'animate' on 'Element': argument 1 must be keyframe object";

export const PARTIAL_KEYFRAMES = "Failed to execute 'animate' on 'Element': Partial keyframes are not supported";
